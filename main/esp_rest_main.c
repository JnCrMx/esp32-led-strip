...
#define MDNS_INSTANCE "pool lantern web server"

static const char *TAG = "poollantern";
...
static void initialise_mdns(void)
{
	...
	ESP_ERROR_CHECK(mdns_service_add("PoolLantern-WebServer", "_http", "_tcp", 80, serviceTxtData,
